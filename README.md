# Agri Digital Twin Simulation

A 3D digital twin visualization tool for agricultural simulation. It connects telemetry sensors to 3D crop models to display irrigation and plant health levels.

---

## Technical Stack
* Languages and Frameworks: TypeScript, React, Three.js, WebSockets
...
1. Clone the repository:
   git clone https://github.com/humanity-co/agri-digital-twin-simulation.git
   cd agri-digital-twin-simulation
